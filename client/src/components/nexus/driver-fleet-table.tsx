...
import { Search, Bike, Car, Truck as TruckIcon } from 'lucide-react'
        ...
        {filteredDrivers.length === 0 ? (
          ...
          <div className="divide-y divide-slate-700/50">
            {filteredDrivers.map((driver) => {
              const vt = driver.vehicleType as keyof typeof vehicleIcons
              const VehicleIcon = vehicleIcons[vt] ?? Bike
